"""
Django settings for shrill_shape_dev_73621 project.
...
ROOT_URLCONF = 'shrill_shape_dev_73621.urls'
...
WSGI_APPLICATION = 'shrill_shape_dev_73621.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_shape_dev_73621 API",
    "DESCRIPTION": "API documentation for shrill_shape_dev_73621 App",
    "VERSION": "v1",
}
